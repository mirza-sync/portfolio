  ...
  return (
    <section id="about" className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] dark:bg-gray-900 px-4">
        <div className="pt-10 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-10 gap-x-20">
          {/* Social Buttons */}
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex justify-center md:justify-start">
              <h1 className="bg-white text-gray-900 text-3xl rounded-lg px-2 py-1 mt-5 inline-block font-bold shadow-md">
                Tech Stack
              </h1>
            </div>
